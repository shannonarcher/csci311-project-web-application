...
<head>
  ...
  <link rel=stylesheet href="{{ URL::to('/gantt') }}/platform.css" type="text/css">
  <link rel=stylesheet href="{{ URL::to('/gantt') }}/libs/dateField/jquery.dateField.css" type="text/css">

  <link rel=stylesheet href="{{ URL::to('/gantt') }}/gantt.css" type="text/css">
  <link rel=stylesheet href="{{ URL::to('/gantt') }}/ganttPrint.css" type="text/css" media="print">

  <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.8/jquery.min.js"></script>
  <script src="http://ajax.googleapis.com/ajax/libs/jqueryui/1.8/jquery-ui.min.js"></script>

  <script src="{{ URL::to('/gantt') }}/libs/jquery.livequery.min.js"></script>
  <script src="{{ URL::to('/gantt') }}/libs/jquery.timers.js"></script>
  <script src="{{ URL::to('/gantt') }}/libs/platform.js"></script>
  <script src="{{ URL::to('/gantt') }}/libs/date.js"></script>
  <script src="{{ URL::to('/gantt') }}/libs/i18nJs.js"></script>
  <script src="{{ URL::to('/gantt') }}/libs/dateField/jquery.dateField.js"></script>
  <script src="{{ URL::to('/gantt') }}/libs/JST/jquery.JST.js"></script>

  <link rel="stylesheet" type="text/css" href="{{ URL::to('/gantt') }}/libs/jquery.svg.css">
  <script type="text/javascript" src="{{ URL::to('/gantt') }}/libs/jquery.svg.min.js"></script>

  <!--In case of jquery 1.7-->
  <!--<script type="text/javascript" src="libs/jquery.svgdom.pack.js"></script>-->

  <!--In case of jquery 1.8-->
  <script type="text/javascript" src="{{ URL::to('/gantt') }}/libs/jquery.svgdom.1.8.js"></script>


  <script src="{{ URL::to('/gantt') }}/ganttUtilities.js"></script>
  <script src="{{ URL::to('/gantt') }}/ganttTask.js"></script>
  <script src="{{ URL::to('/gantt') }}/ganttDrawerSVG.js"></script>
  <!--<script src="ganttDrawer.js"></script>-->
  <script src="{{ URL::to('/gantt') }}/ganttGridEditor.js"></script>
  <script src="{{ URL::to('/gantt') }}/ganttMaster.js"></script>  
</head>
